...
public class LocaleReader {
    ...
    public static void reload() {
        ...
        NATION_WAR_TIME_LEFT = config.getString("nation-war-time-left", "&bThere are &f{TIME_LEFT}&b left in the war");
        ...
        TOWN_WAR_TIME_LEFT = config.getString("town-war-time-left", "&bDefenders need to contest attackers for &f{TIME_LEFT}&b to win\n&bAttackers need {SECONDS_FOR_ATTACKER_WIN} of occupancy without combat to win");
